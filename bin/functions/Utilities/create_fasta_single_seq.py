...
import os
save_folder = '/home/u2188/PredProj/data/datasets/separated_seqs_50new'
read_file = '/home/u2188/PredProj' #Write the main path to the project directory
#os.chdir (main_path)
filename = os.path.join('/home/u2188/PredProj', 'data','datasets','database_50newproteins_asa.txt')
