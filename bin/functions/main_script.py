...
save_file = os.path.join(main_path, 'results','parametricAnal_kern_REGULARIZATION_20170312.txt')
...
kern_range = ['linear']#['poly', 'rbf','linear']#['linear', 'poly', 'rbf', 'sigmoid'] #Choose the kernel function for SVM
cv_range = [7]#[3,5,7,9] #number of training datasets (plus the test dataset) for cross-validation
C_range = [1]#[0.001,0.005,0.01,0.07,0.1,0.5,1]
